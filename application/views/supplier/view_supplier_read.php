          ...
          <div class='row'>
            <div class='col-xs-12'>
              <div class='box box-primary'>
                ...
                <h3 class='box-title'> Detail Supplier Read</h3>
        <table class="table table-bordered">
	    <tr><td>Supplier</td><td><?php echo $supplier_nama; ?></td></tr>
	    <tr><td>User</td><td><?php echo $user_id; ?></td></tr>
	</table>
        <div class='box-footer'>
        <a href="<?php echo site_url('supplier') ?>" class="btn btn-primary">Back</a>
        </div>
        </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
